...
pub const initial_food_count = 100;
...
pub const initial_energy = 100;
pub const energy_loss_per_iteration = 1;
pub const energy_loss_per_movement = 5;
pub const energy_loss_per_replication = 10;
pub const food_energy = 10;
pub const chomps_to_be_selected = 2;

pub const spawn_food_interval = 30;